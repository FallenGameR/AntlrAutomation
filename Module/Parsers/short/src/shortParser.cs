...
public partial class shortParser : Antlr.Runtime.Parser
{
	...
	public shortParser(ITokenStream input)
		: this(input, new RecognizerSharedState())
	{
	}
	public shortParser(ITokenStream input, RecognizerSharedState state)
		: base(input, state)
	{
	...
	public AstParserRuleReturnScope<AutomationTree, CommonToken> file()
	{
		...
		try
		{
			...
			DebugLocation(23, 16);
			EOF2=(CommonToken)Match(input,EOF,Follow._EOF_in_file97);  
			stream_EOF.Add(EOF2);
	...
	private AstParserRuleReturnScope<AutomationTree, CommonToken> section()
	{
		...
		try
		{
			...
			DebugLocation(26, 21);
			string_literal5=(CommonToken)Match(input,9,Follow._9_in_section123);  
	...
	{
		public static readonly BitSet _section_in_file94 = new BitSet(new ulong[]{0x0UL});
		public static readonly BitSet _EOF_in_file97 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _10_in_section118 = new BitSet(new ulong[]{0x280UL});
		public static readonly BitSet _WORD_in_section120 = new BitSet(new ulong[]{0x280UL});
		public static readonly BitSet _9_in_section123 = new BitSet(new ulong[]{0x2UL});
	}
