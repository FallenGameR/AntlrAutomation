...
// $ANTLR 3.4.1.9004 S:\\github\\AntlrAutomation\\Module\\Parsers\\Grammar\\Grammar.g3 2012-12-23 00:17:58
...
public partial class GrammarParser : Antlr.Runtime.Parser
{
	...
	// $ANTLR start "file"
	// S:\\github\\AntlrAutomation\\Module\\Parsers\\Grammar\\Grammar.g3:22:8: public file : ( section )+ EOF -> ^( FILE ( section )+ ) ;
	[GrammarRule("file")]
	public AstParserRuleReturnScope<AutomationTree, CommonToken> file()
	{
		...
		try
		{
			// S:\\github\\AntlrAutomation\\Module\\Parsers\\Grammar\\Grammar.g3:23:5: ( ( section )+ EOF -> ^( FILE ( section )+ ) )
			DebugEnterAlt(1);
			// S:\\github\\AntlrAutomation\\Module\\Parsers\\Grammar\\Grammar.g3:23:7: ( section )+ EOF
			{
			DebugLocation(23, 7);
			// S:\\github\\AntlrAutomation\\Module\\Parsers\\Grammar\\Grammar.g3:23:7: ( section )+
			int cnt1=0;
			...
			{
				DebugLocation(23, 23);
				// S:\\github\\AntlrAutomation\\Module\\Parsers\\Grammar\\Grammar.g3:23:23: ^( FILE ( section )+ )
				{
	...
	// $ANTLR start "section"
	// S:\\github\\AntlrAutomation\\Module\\Parsers\\Grammar\\Grammar.g3:26:1: section : 'start' ( WORD )* 'end' -> ^( SECTION ( WORD )* ) ;
	[GrammarRule("section")]
	private AstParserRuleReturnScope<AutomationTree, CommonToken> section()
	{
		...
		try
		{
			// S:\\github\\AntlrAutomation\\Module\\Parsers\\Grammar\\Grammar.g3:27:5: ( 'start' ( WORD )* 'end' -> ^( SECTION ( WORD )* ) )
			DebugEnterAlt(1);
			// S:\\github\\AntlrAutomation\\Module\\Parsers\\Grammar\\Grammar.g3:27:7: 'start' ( WORD )* 'end'
			{
			DebugLocation(27, 7);
			...
			DebugLocation(27, 15);
			// S:\\github\\AntlrAutomation\\Module\\Parsers\\Grammar\\Grammar.g3:27:15: ( WORD )*
			...
			{
				DebugLocation(27, 30);
				// S:\\github\\AntlrAutomation\\Module\\Parsers\\Grammar\\Grammar.g3:27:30: ^( SECTION ( WORD )* )
				{
				AutomationTree root_1 = (AutomationTree)adaptor.Nil();
				DebugLocation(27, 32);
				...
				DebugLocation(27, 40);
				// S:\\github\\AntlrAutomation\\Module\\Parsers\\Grammar\\Grammar.g3:27:40: ( WORD )*
