...
// $ANTLR 3.4.1.9004 D:\\Archive\\Projects\\AntlrAutomation\\Module\\Parsers\\SimpletonCopy\\SimpletonCopy.g3 2012-12-27 23:59:53
...
public partial class SimpletonCopyParser : Antlr.Runtime.Parser
{
	...
	// $ANTLR start "file"
	// D:\\Archive\\Projects\\AntlrAutomation\\Module\\Parsers\\SimpletonCopy\\SimpletonCopy.g3:22:8: public file : ( section )+ EOF -> ^( FILE ( section )+ ) ;
	[GrammarRule("file")]
	public AstParserRuleReturnScope<AutomationTree, CommonToken> file()
	{
		...
		try
		{
			// D:\\Archive\\Projects\\AntlrAutomation\\Module\\Parsers\\SimpletonCopy\\SimpletonCopy.g3:23:5: ( ( section )+ EOF -> ^( FILE ( section )+ ) )
			DebugEnterAlt(1);
			// D:\\Archive\\Projects\\AntlrAutomation\\Module\\Parsers\\SimpletonCopy\\SimpletonCopy.g3:23:7: ( section )+ EOF
			{
			DebugLocation(23, 7);
			// D:\\Archive\\Projects\\AntlrAutomation\\Module\\Parsers\\SimpletonCopy\\SimpletonCopy.g3:23:7: ( section )+
			int cnt1=0;
			...
			{
				DebugLocation(23, 23);
				// D:\\Archive\\Projects\\AntlrAutomation\\Module\\Parsers\\SimpletonCopy\\SimpletonCopy.g3:23:23: ^( FILE ( section )+ )
				{
	...
	// $ANTLR start "section"
	// D:\\Archive\\Projects\\AntlrAutomation\\Module\\Parsers\\SimpletonCopy\\SimpletonCopy.g3:26:1: section : 'start' ( WORD )* 'end' -> ^( SECTION ( WORD )* ) ;
	[GrammarRule("section")]
	private AstParserRuleReturnScope<AutomationTree, CommonToken> section()
	{
		...
		try
		{
			// D:\\Archive\\Projects\\AntlrAutomation\\Module\\Parsers\\SimpletonCopy\\SimpletonCopy.g3:27:5: ( 'start' ( WORD )* 'end' -> ^( SECTION ( WORD )* ) )
			DebugEnterAlt(1);
			// D:\\Archive\\Projects\\AntlrAutomation\\Module\\Parsers\\SimpletonCopy\\SimpletonCopy.g3:27:7: 'start' ( WORD )* 'end'
			{
			DebugLocation(27, 7);
			...
			DebugLocation(27, 15);
			// D:\\Archive\\Projects\\AntlrAutomation\\Module\\Parsers\\SimpletonCopy\\SimpletonCopy.g3:27:15: ( WORD )*
			...
			{
				DebugLocation(27, 30);
				// D:\\Archive\\Projects\\AntlrAutomation\\Module\\Parsers\\SimpletonCopy\\SimpletonCopy.g3:27:30: ^( SECTION ( WORD )* )
				{
				AutomationTree root_1 = (AutomationTree)adaptor.Nil();
				DebugLocation(27, 32);
				...
				DebugLocation(27, 40);
				// D:\\Archive\\Projects\\AntlrAutomation\\Module\\Parsers\\SimpletonCopy\\SimpletonCopy.g3:27:40: ( WORD )*
